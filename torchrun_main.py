...
from utils.dataloader import PreprocessedIterableDataset, PreprocessedIterableDataset_noslice
from utils.dataloader_v2 import PreprocessedIterableDataset_v2
...
def main(args):
    ...
    if global_rank == 0:
        wandb.init(project="scale", name=args.model_name)
                ...
                wandb.log(
                    {
                        ...
                        "final_perplexity": np.exp(total_loss),
